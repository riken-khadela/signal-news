...
from settings import get_request, get_scrape_do_requests, HTN_CO_UK_client as news_details_client, yourstory_scrape_do_requests
from datetime import datetime
...
logger = CustomLogger(log_folder="/home/riken/news-scrapper/news-scrapper/past_data/Logs/htn_co_uk")
URLS_list = [
