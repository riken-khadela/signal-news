...
from settings import get_request, get_scrape_do_requests, HEALTHTECHASIA_client as news_details_client, yourstory_scrape_do_requests
from datetime import datetime
...
logger = CustomLogger(log_folder="/home/riken/news-scrapper/news-scrapper/past_data/Logs/HealthTechAsia")
URLS_list = [
    ...
    def separate_blog_details(self, response, grid):
        ...
        try:
            ...
            if time_ele :
                ...
                details['time'] = time if time else time_ele.get_text(strip=True)
