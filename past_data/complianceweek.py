...
from settings import get_request, get_scrape_do_requests, COMPLIANCEWEEK_client as news_details_client, yourstory_scrape_do_requests
from datetime import datetime
...
logger = CustomLogger(log_folder="/home/riken/news-scrapper/news-scrapper/past_data/Logs/ComplianceWeek")
URLS_list = [
    ...
    def scrape_grid_data(self, html_content):
        ...
        for children in main_children:
            try:
                ...
                # title
                title_ele = children.find('h3') if children.find('h3') else children.find('h2') if children.find('h2') else children.find('h1') if children.find('h1') else children.find('h4') if children.find('h4') else children.find('h5') if children.find('h5') else children.find('h6') 
                if title_ele :
