...
from settings import get_request, get_scrape_do_requests, WORLDOIL_client as news_details_client, yourstory_scrape_do_requests
from datetime import datetime
...
logger = CustomLogger(log_folder="/home/riken/news-scrapper/news-scrapper/past_data/Logs/worldoil")
URLS_list = [
        ...
        for children in main_children:
            try:
                ...
                if link_ele :
                    ...
                    if a_ele:
                        href = a_ele.get('href')
                        tmp['url'] = href if "https://www.worldoil.com" in href else f"https://www.worldoil.com{a_ele.get('href')}"
